    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.left:
                ...
                if (s1.equals(getResources().getString(R.string.partit2))) {//Canviem de pantalla
                ...
                } else if (s1.equals(getResources().getString(R.string.partit3))) {//Canviem de pantalla
                ...
                } else if (s1.equals(getResources().getString(R.string.partit4))) {//Canviem de pantalla
                ...
                } else if (s1.equals(getResources().getString(R.string.partit5))) {//Canviem de pantalla
            ...
            case R.id.right:
                ...
                if (s.equals(getResources().getString(R.string.partit1))) {//Canviem de pantalla
                    titol.setText(getResources().getString(R.string.partit2));
                    gols = new PartitAdapter(getApplicationContext(), p2.getGolejadors());
                    mRecyclerView.setAdapter(gols);
                ...
                } else if (s.equals(getResources().getString(R.string.partit2))) {//Canviem de pantalla
                    titol.setText(getResources().getString(R.string.partit3));
                    gols = new PartitAdapter(getApplicationContext(), p3.getGolejadors());
                    mRecyclerView.setAdapter(gols);
                ...
                } else if (s.equals(getResources().getString(R.string.partit3))) {//Canviem de pantalla
                    titol.setText(getResources().getString(R.string.partit4));
                    gols = new PartitAdapter(getApplicationContext(), p4.getGolejadors());
                    mRecyclerView.setAdapter(gols);
                ...
                } else if (s.equals(getResources().getString(R.string.partit4))) {//Canviem de pantalla
                    titol.setText(getResources().getString(R.string.partit5));
                    gols = new PartitAdapter(getApplicationContext(), p5.getGolejadors());
                    mRecyclerView.setAdapter(gols);
